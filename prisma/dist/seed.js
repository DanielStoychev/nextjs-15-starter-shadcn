...
async function main() {
    ...
    const tablePredictor = await prisma.game.upsert({
        ...
        create: {
            ...
            description: 'Arrange all 20 Premier League teams in the order you predict the table will finish at the end of the season. Predict the total number of goals scored in the Premier League season by all teams combined for tie-breaking.'
        }
    });
